...
from decorators import logger_decorator, logger_decorator_param
url_write = '/Users/dmitrijmalkov/PycharmProjects/scraping/file.txt'
...
#3 задание
@logger_decorator_param(url_write)
